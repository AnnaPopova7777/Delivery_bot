...
class DatabaseManager(object):
    ...
    def create_tables(self):
        ...
        self.query('CREATE TABLE IF NOT EXISTS announcement (idx text, title text)')
        self.query('CREATE TABLE IF NOT EXISTS changeprice (idx text, title text)')
        self.query('CREATE TABLE IF NOT EXISTS rewiews_users (idx text, title_r text)')
